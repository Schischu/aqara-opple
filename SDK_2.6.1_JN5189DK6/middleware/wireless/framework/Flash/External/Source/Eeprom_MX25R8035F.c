...
#define CMD_SPIFI_READ_ID            (9)
#define CMD_SPIFI_DP                 (10)
#define CMD_SPIFI_RES                (11)
#define CMD_SPIFI_NUM                (12)
...
#if (defined(FSL_FEATURE_SPIFI_DUAL_MODE) && (FSL_FEATURE_SPIFI_DUAL_MODE > 0))
