 ...
 * A temperature sweep has been performed from -40¡ãC to +125¡ãC in 5¡ãC step and the frequency accuracy
 ...
 * The 32k compensation turns out inefficient outside the -40¡ãC to +80¡ãC range.
 *
 *
 *
 **/
